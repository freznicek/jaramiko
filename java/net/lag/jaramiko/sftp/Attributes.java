...
public class Attributes implements Comparable<Attributes> {
    ...
    public static Attributes fromMessage(Message message) {
        ...
        if ((attributes.flags & FLAG_SIZE) != 0) attributes.st_size = message
                .getInt64();
        if ((attributes.flags & FLAG_UIDGID) != 0) {
            attributes.st_uid = message.getInt();
            attributes.st_gid = message.getInt();
        }
        if ((attributes.flags & FLAG_PERMISSIONS) != 0) attributes.st_mode = message
                .getInt();
    ...
    public void setSt_size(Long st_size) {
        ...
        if (st_size != null) flags |= FLAG_SIZE;
        else
            flags &= ~FLAG_SIZE;
    }
    ...
    public void setSt_uid(Integer st_uid) {
        this.st_uid = st_uid;
        if (st_uid != null && this.st_gid != null) flags |= FLAG_UIDGID;
        else
            flags &= ~FLAG_UIDGID;
    }
    ...
    public void setSt_gid(Integer st_gid) {
        this.st_gid = st_gid;
        if (st_uid != null && this.st_uid != null) flags |= FLAG_UIDGID;
        else
            flags &= ~FLAG_UIDGID;
    }
    ...
    public void setSt_mode(Integer st_mode) {
        ...
        if (st_mode != null) flags |= FLAG_PERMISSIONS;
        else
    ...
    public void setSt_atime(Integer st_atime) {
        ...
        if (st_atime != null && this.st_mtime != null) flags |= FLAG_AMTIME;
        else
            flags &= ~FLAG_AMTIME;
    }
    ...
    public void setSt_mtime(Integer st_mtime) {
        ...
        if (st_atime != null && st_mtime != null) flags |= FLAG_AMTIME;
        else
            flags &= ~FLAG_AMTIME;
    }
    ...
    public void toMessage(Message message) {
        this.flags = 0;
        if (this.st_size != null) this.flags |= FLAG_SIZE;
        if (this.st_uid != null && this.st_gid != null) this.flags |= FLAG_UIDGID;
        if (this.st_mode != null) this.flags |= FLAG_PERMISSIONS;
        if (this.st_atime != null && this.st_mtime != null) this.flags |= FLAG_AMTIME;
        if (!this.attr.isEmpty()) this.flags |= FLAG_EXTENDED;
        message.putInt(this.flags);
        if ((this.flags & FLAG_SIZE) != 0) message.putInt64(this.st_size);
        if ((this.flags & FLAG_UIDGID) != 0) {
            message.putInt(this.st_uid);
            message.putInt(this.st_gid);
        }
        if ((this.flags & FLAG_PERMISSIONS) != 0) message.putInt(this.st_mode);
        if ((this.flags & FLAG_AMTIME) != 0) {
            // throw away any fractional seconds
            message.putInt(this.st_atime);
            message.putInt(this.st_mtime);
        }
    ...
    public int compareTo(Attributes o) {
        ...
        if (result == 0) {
            ...
            if (result == 0) {
                ...
                if (result == 0) {
                    result = (st_mode == o.st_mode) ? 0 : st_mode
                            .compareTo(o.st_mode);
                    if (result == 0) {
                        result = (st_atime == o.st_atime) ? 0 : st_atime
                                .compareTo(o.st_atime);
                        if (result == 0) {
                            result = (st_mtime == o.st_mtime) ? 0 : st_mtime
                                    .compareTo(o.st_mtime);
                        }
                    }
                }
            }
